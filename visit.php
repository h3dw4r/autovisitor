...
echo "$cyan   +///////////////////////////////+\n";
echo "    ~~~~~~ AUTO VISITOR  2018 ~~~~~\n  ";
echo "$cyan + //////////////////////////////+\n";
echo "";
echo "$kuning ©® $hijau Putra Tuyul |√|\n";
echo "\n";
echo "$merah !!!!....WARNING...!!!!!\n";
echo "$magenta Tidak untuk dibagikan dalam posting atau dipamerkan \n";
echo "\n";
echo "\n";
echo "===========================================\n";
echo "\n";echo "\n";echo "Selamat Datang\n";
...
for($i = 1; $i < $max+1; $i++) {
	...
	echo $i.".$magenta $url \n";
  echo "$hijau Telah diKunjungi Oleh Server[".$class->jalankan()."]\n";
}
?>
